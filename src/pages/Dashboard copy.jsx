          ...
          <div className="home-header-container" style={{
            ...
            >
              ...
              <div>
                ...
                <div className="home-logo-subtitle" style={{ fontSize: '12px', color: '#8E8E93', marginTop: '4px' }}>Безопасная экосистема</div>
              </div>
            </div>
        ...
        <section className="dashboard-section" style={{ paddingTop: '100px', paddingBottom: '80px' }}>
          <div className="dashboard-content" style={{ maxWidth: '1440px', margin: '0 auto', padding: '0 48px' }}>
            <div style={{ animation: 'fadeIn 0.8s ease', marginBottom: '32px' }}>
              <h1 className="dashboard-title" style={{ fontSize: '64px', fontWeight: '800', letterSpacing: '-2.5px', marginBottom: '20px', color: '#000000', lineHeight: 1, fontFamily: '-apple-system, BlinkMacSystemFont, "SF Pro Display", "Helvetica Neue", sans-serif' }}>Каталог товаров</h1>
              <p className="dashboard-description" style={{ fontSize: '19px', color: '#86868B', marginBottom: 0, fontWeight: 400, lineHeight: 1.6, maxWidth: '640px', letterSpacing: '-0.2px' }}>
                Всё, что вы видите — у нас в наличии.<br />
                Размеры указаны рядом с каждым товаром.
              </p>
            </div>
            <div className="dashboard-badge" style={{
              display: 'inline-flex', alignItems: 'center', gap: 14, padding: '16px 24px', borderRadius: 100,
              background: 'rgba(245, 245, 247, 0.8)', color: '#1D1D1F', fontWeight: 500, marginBottom: 56, border: 'none',
              boxShadow: 'inset 0 0 0 1px rgba(0, 0, 0, 0.06), 0 1px 2px rgba(0, 0, 0, 0.04)', animation: 'slideUp 0.6s ease 0.2s backwards, float 3s ease-in-out 1s infinite', fontSize: '16px', backdropFilter: 'blur(10px)', letterSpacing: '-0.2px'
            }}>
              <span style={{ width: 10, height: 10, background: '#30D158', borderRadius: '50%', display: 'inline-block', animation: 'glow 2s ease-in-out infinite' }} />
              Сегодня в смене продавец: {todaySellers.length ? todaySellers.join(', ') : 'никто не назначен'}
            </div>
            {scheduleErr && (
            ...
            {loading ? (
              <div style={{ padding: '80px 0', textAlign: 'center' }}>
                ...
                <div style={{ fontSize: '17px', color: '#86868B', fontWeight: 500 }}>Загрузка товаров...</div>
              </div>
            ) : (
                ...
                {products.map((p, idx) => (
                  <div key={p.id} className="product-card" style={{ borderRadius: '20px', overflow: 'hidden', background: '#FBFBFD', border: '1px solid rgba(0, 0, 0, 0.06)', transition: 'all 0.5s cubic-bezier(0.4, 0, 0.2, 1)', cursor: 'pointer', animation: `scaleIn 0.5s ease ${idx * 0.05}s backwards`, position: 'relative' }}
                    ...
                    <div className="product-content" style={{ padding: '20px' }}>
                      ...
                      {!!p.barcode && <div style={{ fontSize: '13px', color: '#86868B', marginBottom: '12px', fontWeight: 400 }}>Штрихкод: {p.barcode}</div>}
                      ...
                      <button onClick={() => addToCart(p)} className="product-button" style={{
                        marginTop: '20px', width: '100%', padding: '16px 24px', background: 'linear-gradient(180deg, #007AFF 0%, #0051D5 100%)', border: 'none', borderRadius: '14px', color: '#FFFFFF', fontWeight: '600', cursor: 'pointer', fontSize: '16px', transition: 'all 0.25s cubic-bezier(0.4, 0, 0.2, 1)', letterSpacing: '-0.3px', boxShadow: '0 2px 8px rgba(0, 122, 255, 0.25)', position: 'relative', overflow: 'hidden', WebkitTapHighlightColor: 'transparent'
                      }}
                        onMouseEnter={(e) => { e.target.style.transform = 'translateY(-2px) scale(1.02)'; e.target.style.boxShadow = '0 8px 20px rgba(0, 122, 255, 0.35)' }}
                        onMouseLeave={(e) => { e.target.style.transform = 'translateY(0) scale(1)'; e.target.style.boxShadow = '0 2px 8px rgba(0, 122, 255, 0.25)' }}
                        onTouchStart={(e) => { e.target.style.transform = 'scale(0.95)'; e.target.style.boxShadow = '0 4px 12px rgba(0, 122, 255, 0.4)' }}
                        onTouchEnd={(e) => { e.target.style.transform = 'scale(1)'; e.target.style.boxShadow = '0 2px 8px rgba(0, 122, 255, 0.25)' }}>
                        Заказать
                      </button>
                    </div>
                  </div>
            ...
            {!loading && products.length === 0 && !error && (
              <div style={{ padding: '120px 20px', textAlign: 'center', animation: 'fadeIn 0.8s ease' }}>
                ...
                <div style={{ fontSize: '28px', fontWeight: '600', color: '#1D1D1F', marginBottom: '12px', letterSpacing: '-0.5px' }}>Товары скоро появятся</div>
                <div style={{ fontSize: '17px', color: '#86868B', fontWeight: 400, maxWidth: '400px', margin: '0 auto', lineHeight: 1.5 }}>Мы работаем над пополнением каталога</div>
              </div>
            )}
          </div>
        </section>
        ...
        {sizeModalOpen && sizeProduct && (
          <div style={{
            ...
            <div onClick={(e) => e.stopPropagation()} className="mobile-size-modal" style={{
              ...
              <div className="mobile-size-subtitle" style={{ fontSize: '17px', color: '#86868B', marginBottom: '28px', fontWeight: 400 }}>Выберите размер</div>
              ...
              {selectedSize && (() => {
                ...
                return (
                  <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginTop: '20px', padding: '16px 20px', background: '#F5F5F7', borderRadius: '12px', border: '1px solid rgba(0, 0, 0, 0.04)' }}>
                    ...
                    <span style={{ color: '#1D1D1F', fontWeight: 500, fontSize: '15px' }}>В наличии: {qty} шт.</span>
                  </div>
                )
              })()}
              <div className="mobile-size-actions" style={{ display: 'flex', gap: '12px', marginTop: '28px' }}>
                <button onClick={() => { setSizeModalOpen(false); setSizeProduct(null); setSelectedSize(null) }} className="mobile-size-action-btn" style={{
                  ...
                  onTouchEnd={(e) => { e.target.style.background = '#F5F5F7'; e.target.style.transform = 'scale(1)' }}>Отмена</button>
                <button onClick={confirmSizeAndAdd} disabled={!selectedSize} className="mobile-size-action-btn" style={{
                  ...
                  onTouchEnd={(e) => { if (selectedSize) { e.target.style.background = '#007AFF'; e.target.style.transform = 'scale(1)' } }}>Добавить</button>
              </div>
            </div>
          </div>
        )}
        ...
        <footer className="mobile-footer" style={{
          ...
          <div style={{ maxWidth: '1200px', margin: '0 auto', position: 'relative', zIndex: 1 }}>
            <div className="mobile-footer-grid" style={{
              ...
              <div className="mobile-footer-section">
                <div className="mobile-footer-title" style={{ fontSize: '13px', fontWeight: '800', color: '#8E8E93', marginBottom: '20px', letterSpacing: '1.2px', textTransform: 'uppercase' }}>Навигация</div>
                <div onClick={() => navigate('/profile')} className="mobile-footer-nav-item" style={{ fontSize: '15px', marginBottom: '12px', cursor: 'pointer', color: '#1C1C1E', fontWeight: '500', transition: 'all 0.2s ease', WebkitTapHighlightColor: 'transparent' }}
                ...
                <div onClick={() => navigate('/news')} className="mobile-footer-nav-item" style={{ fontSize: '15px', marginTop: '12px', cursor: 'pointer', color: '#1C1C1E', fontWeight: '500', transition: 'all 0.2s ease', WebkitTapHighlightColor: 'transparent' }}
                  onMouseEnter={(e) => { e.currentTarget.style.color = '#5856D6'; e.currentTarget.style.paddingLeft = '8px' }}
                  onMouseLeave={(e) => { e.currentTarget.style.color = '#1C1C1E'; e.currentTarget.style.paddingLeft = '0' }}
                  onTouchStart={(e) => e.currentTarget.style.color = '#5856D6'}
                  onTouchEnd={(e) => e.currentTarget.style.color = '#1C1C1E'}>
              ...
              <div className="mobile-footer-section">
                <div className="mobile-footer-title" style={{ fontSize: '13px', fontWeight: '800', color: '#8E8E93', marginBottom: '20px', letterSpacing: '1.2px', textTransform: 'uppercase' }}>Социальные сети</div>
                {[
              ...
              <div className="mobile-footer-section">
                <div className="mobile-footer-title" style={{ fontSize: '13px', fontWeight: '800', color: '#8E8E93', marginBottom: '20px', letterSpacing: '1.2px', textTransform: 'uppercase' }}>Информация</div>
