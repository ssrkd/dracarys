                            ...
                            {items.map((item) => (
                                ...
                                >
                                    ...
                                    <div className="flex-1">
                                        ...
                                        {item.selectedSize && (
                                            <p className="text-[10px] font-black uppercase tracking-widest text-gray mb-1">
                                        ...
                                        <div className="flex items-center gap-2">
                                            ...
                                            {(() => {
                                                const maxQty = inventoryService.qtyFor(availability, item.name, item.selectedSize);
                        ...
                        <Button
                            ...
                            onClick={() => {
                                const message = `Здравствуйте! Хочу оформить заказ в Dracarys Store:\n\n${items.map(item => {
                                    ...
                                    return `- ${item.name}${barcode}${size} x${item.quantity}: ${effectivePrice * item.quantity} ₸`;
                                }).join('\n')}\n\n*Итого: ${total} ₸*`;
